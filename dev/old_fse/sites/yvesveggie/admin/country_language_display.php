		...
		<form name="login" action="login.php" method="post">
			...
			<div style="margin: 5px 5px 5px 5px;">
				...
				<div class="contentbox">
					<span class="title">Display all countries &amp; Languages</span>	
						...
						if( $db->numRows( $displayResult ) ) {
							while( list( $countryId, $name, $live ) = $db->fetchRow( $displayResult ) ) {	?>
								<div style="padding-top: 4px; padding-bottom: 4px; background-color: <?= $bgColor ? "#fcfafb" : "#faf7f2"; ?>;" onmouseover="this.style.backgroundColor='#f0f2f2';" onmouseout="this.style.backgroundColor='<?= $bgColor ? "#fcfafb" : "#faf7f2"; ?>';">
									...
									<div class="right" style="width: 15%; text-align: right;"><a href="country_edit.php?country_id=<?= $countryId; ?>">edit</a> &middot; <a href="javascript:void(delItem('country_language_display.php','<?= $countryId; ?>','countries','country_id'));">delete</a></div>
									<div class="spacer"></div>
								</div>
					<?		$bgColor = !$bgColor;
							}
						...
						if( $db->numRows( $displayResult ) ) {
							while( list( $languageId, $name, $live ) = $db->fetchRow( $displayResult ) ) {	?>
								<div style="padding-top: 4px; padding-bottom: 4px; background-color: <?= $bgColor ? "#fcfafb" : "#faf7f2"; ?>;" onmouseover="this.style.backgroundColor='#f0f2f2';" onmouseout="this.style.backgroundColor='<?= $bgColor ? "#fcfafb" : "#faf7f2"; ?>';">
									<div class="left" style="width: 50%;"><?= $name; ?></div>
									<div class="left" style="width: 20%;"><?= ($live == "Y" ? "Yes" : "No"); ?></div>
									<div class="right" style="width: 15%; text-align: right;"><a href="language_edit.php?language_id=<?= $languageId; ?>">edit</a> &middot; <a href="javascript:void(delItem('country_language_display.php','<?= $languageId; ?>','language','language_id'));">delete</a></div>
									<div class="spacer"></div>
								</div>
					<?		$bgColor = !$bgColor;
							}
