	...
	<body>
		...
		<div style="margin: 5px 5px 5px 5px;">
			...
			<div class="contentbox">
				<span class="title">Display all FAQs</span>	
								...
								while( list( $languageId, $languageName ) = $db->fetchRow( $languageResult ) ) {
									...
									if( $languageCount > 0 ) {
										...
										<div class="innercontent" style="width: 555px;">
											<div class="left" style="width: 30%;"><b>Question</b></div>
											<div class="left" style="width: 45%; padding-left: 5px;"><b>Answer</b></div>
											<div class="left" style="width: 2%; padding-left: 15px;"><b>Priority</b></div>
											<div class="spacer"></div>
											<div class="divider"></div>
										
									<?	$displayResult = $db->query( "select faq_id, question, answer, priority ".
									                                 "  from faq ".
											...
											if( $db->numRows( $displayResult ) ) {
												$bgColor = false;
												while( list( $faqId, $question, $answer, $priority ) = $db->fetchRow( $displayResult ) ) {	?>
													<div style="padding-top: 4px; padding-bottom: 4px; background-color: <?= $bgColor ? "#fcfafb" : "#faf7f2"; ?>;" onmouseover="this.style.backgroundColor='#eeeeff';" onmouseout="this.style.backgroundColor='<?= $bgColor ? "#fcfafb" : "#faf7f2"; ?>';">									
														<div class="left" style="width: 30%;"><?= $question; ?></div>
														<div class="left" style="padding-left: 5px; width: 45%;"><?= truncWords( strip_tags( $answer ), 15 ); ?></div>
														<div class="left" style="padding-left: 15px; width: 2%;"><?= $priority; ?></div>
														<div class="right" style="width: 15%; text-align: right;"><a href="faq_edit.php?faq_id=<?= $faqId; ?>">edit</a> &middot; <a href="javascript:void(delItem('faq_display.php','<?= $faqId; ?>','faq','faq_id'));">delete</a></div>
