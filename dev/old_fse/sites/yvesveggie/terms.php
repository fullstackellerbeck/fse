...
<html>
	<head>
		<title>Yves Veggie Cuisine - <?= strtr( stripslashes( $pageTitle ), $trans ); ?></title>
		      ...
		      <table width="737" border="0" cellspacing="0" cellpadding="0">
		        ...
		        <tr> 
		          ...
		          <td valign="top" align="left"> 
		            ...
		            <?= ( $autoHTML == "Y" ? nl2br( strtr( stripslashes( $content ), $trans ) ) : strtr( stripslashes( $content ), $trans ) );	?><br>
		            <p>&nbsp;</p>
		        	</td>
		        </tr>
