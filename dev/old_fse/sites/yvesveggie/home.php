...
/*		if( !$_SESSION['sess_country_id'] || !session_is_registered( "sess_language_id" ) ) {
		  ...
		  <tr>
		    <td align="center">
		      <table width="737" border="0" cellspacing="0" cellpadding="0">
		        ...
		        <tr> 
		          <td bgcolor="#FFCC00" rowspan="3" style="background-color: #ffcc00;"><img src="images/universal/spacer.gif" width="3" height="1" alt="" /></td>
		        ...
		        <tr> 
		          ...
		          <td valign="top" align="left"> 
		            <?=  ( $autoHTML == "Y" ? nl2br( prepStr( $content ) ) : prepStr( $content ) );	?><br>
		            <p>&nbsp;</p>
		          </td>
		        </tr>
		        <tr> 
