		      ...
		      <table width="737" border="0" cellspacing="0" cellpadding="0">
		        ...
		        <tr> 
		          ...
		          <td valign="top" align="left"> 
		            ...
		            <p><?= ( $autoHTML == "Y" ? nl2br( prepStr( $content ) ) : prepStr( $content ) );	?></p><br>

						<?	$mediaResults = $db->query( "select release_id, title, release_date ".
						                                "  from media_releases ".
						                                " where country_id  = '$sess_country_id' ".
						                                "   and language_id = '$sess_language_id' ".
						                                "   and live = 'Y'" );
						                                
								if( $db->numRows( $mediaResults ) ) {
									while( list( $releaseId, $title, $releaseDate ) = $db->fetchRow( $mediaResults ) ) {	?>
									<p><?= $releaseDate; ?><br>
									<a href="about_media_display.php?release_id=<?= $releaseId; ?>"><?= strtr( stripslashes( $title ), $trans ); ?></a></p>
							<?	}
								}	?>
