		      ...
		      <table width="737" border="0" cellspacing="0" cellpadding="0">
		        ...
		        <tr> 
		          ...
		          <td valign="top" align="left"> 
		            ...
		            <form name="bunny" method="post" action="stores_results.php">
		              <p><?= prepStr( $copyArr[ "store_search" ] ); ?>&nbsp; 
		                <select name="province_id">
									<?	$provinceResult = $db->query( "select province_id, rel_province_id, name ".
									                                  "  from stores_provinces ".
									                                  " where country_id  = '$sess_country_id' ".
									                                  "   and language_id = '$sess_language_id' ".
									                                  "   and live        = 'Y'" );
									    if( $db->numRows( $provinceResult ) ) {
									    	while( list( $provinceId, $relProvinceId, $name ) = $db->fetchRow( $provinceResult ) ) {	?>
									    		<option value="<?= !$relProvinceId ? $provinceId : $relProvinceId; ?>"><?= $name; ?></option>
									   <?	}
									   	}	?>
		                </select>
		                <a href="javascript:document.bunny.submit();"><img src="images/universal/go.gif" width="30" height="30" align="absmiddle" border="0"/></a></p>
		            </form>
		            <p><br>
		            </p>
		            </td>
