		        ...
		        <tr> 
		          ...
		          <td valign="top" align="left"> 
		            ...
		            <table width="100%" border="0" cellspacing="0" cellpadding="2">
		              <tr>
		                <td valign="bottom" align="left"><p class="small"><?= prepStr( $copyArr[ "immediate_release" ] ); ?><br><?= $releaseDate; ?></p></td>
		                <td valign="bottom" align="right"><p class="small"><a href="javascript:void(window.open('about_media_display_print.php?release_id=<?= $release_id; ?>','print_release','width=440,height=500,scrollbars=yes,menubar=no,statusbar=no,toolbar=yes'));"><?= prepStr( $copyArr[ "print_release" ] ); ?></a></p></td>
		                <td valign="bottom" align="right" width="23"><p class="small"><img src="images/universal/i_print_2.gif" width="23" height="14" /></p></td>
		              </tr>
		            </table>

		            <h3><?= $title; ?></h3>
		            (<?= $location; ?>) &#8212; <?= strtr( stripslashes( $autoHTML == "Y" ? nl2br( $content ) : $content ), $trans ); ?><br>
		            <p>&nbsp;</p>
		            <p class="small"><a href="about_media.php"><?= prepStr( $copyArr[ "release_index" ] ); ?></a></p>
		            <p class="small">&nbsp;</p>
		            </td>
		        </tr>
